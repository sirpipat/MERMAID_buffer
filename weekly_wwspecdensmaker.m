function weekly_wwspecdensmaker(sfax, midval, intval)
% WEEKLY_WWSPECDENSMAKER(sfax, midval, intval)
% Computes spectral density (weekly) of equivalent surface
...
% output location
savedir = '/Users/sirawich/research/processed_data/weekly_WWSD_profiles/';
